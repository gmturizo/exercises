...
public class Main {
    ...
    public static void main(String [] args){
        ...
        Servicio soporte = new Servicio("Soporte Tecnico", (double)300.00F, 5);
        Servicio desarrollo = new Servicio("Desarrollo de software", (double) 5200.00F, 10);

        Factura factura = new Factura("F001", "Gabriel Turizo", null);
